...
<div class="container">
	<div class="box">
		<div class="container">
			<h2 style="font-family: 'Charmonman', cursive;">Japanese jmt</h2>
			<br>
				...
				<tbody>
					<c:forEach var="vo" items="${list }" varStatus="x">
						<tr>
							...
							<td>${vo.region }</td>
							<td style="width: 35%"><a href="jfboard_content.fboard?fno=${vo.fno }" onclick="location.href='jfboard_hitCount.fboard?fno=${vo.fno}'">${vo.title }</a></td>
				...
				<tbody>
					<tr>
						<td colspan="6" align="center">
							<form action="jfboard_search.fboard" class="form-inline">
