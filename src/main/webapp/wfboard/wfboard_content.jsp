								...
								<c:choose>
									<c:when test="${sessionScope.member_id == vo.id }">
										...
										<button type="button" class="btn btn-default"
											onclick="location.href='wfboard_list.fboard?food=양식'">목록</button>
										<button type="button" class="btn btn-default"
											onclick="location.href='wfboard_modify.fboard?fno=${vo.fno}&food=양식'">수정</button>
										<button type="button" class="btn btn-default"
											onclick="location.href='wfboard_delete.fboard?fno=${vo.fno}&food=양식'">삭제</button>
									</c:when>
									<c:otherwise>
										<button type="button" class="btn btn-default"
											onclick="location.href='wfboard_list.fboard?food=양식'">목록</button>
