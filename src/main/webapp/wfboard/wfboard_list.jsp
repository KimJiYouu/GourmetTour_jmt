...
<div class="container">
	<div class="box">
		<div class="container">
			<h2 style="font-family: 'Charmonman', cursive;">Western jmt</h2>
			<br>
				...
				<tbody>
					<c:forEach var="vo" items="${list }" varStatus="x">
						<tr>
							...
							<td>${vo.region }</td>
							<td style="width: 35%"><a href="wfboard_content.fboard?fno=${vo.fno }" onclick="location.href='wfboard_hitCount.fboard?fno=${vo.fno}'">${vo.title }</a></td>
							...
							<input type="hidden" name="food" value="양식">
								...
								<select name="choice" style="width: 70px; height: 30px; font-size: 15px;">
									...
									<input type="text" name="search" placeholder="검색어를 입력하세요"
										...
										<input type="button" value="글 작성" class="btn btn-default" onclick="location.href='wfboard_write.fboard'">
										</c:if>
								</div>
							</form>
						</td>
