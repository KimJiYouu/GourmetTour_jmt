								...
								<c:choose>
									<c:when test="${sessionScope.member_id == vo.id }">
										...
										<button type="button" class="btn btn-default"
											onclick="location.href='kfboard_list.fboard?food=한식'">목록</button>
										<button type="button" class="btn btn-default"
											onclick="location.href='kfboard_modify.fboard?fno=${vo.fno}&food=한식'">수정</button>
										<button type="button" class="btn btn-default"
											onclick="location.href='kfboard_delete.fboard?fno=${vo.fno}&food=한식'">삭제</button>
									</c:when>
									<c:otherwise>
										<button type="button" class="btn btn-default"
											onclick="location.href='kfboard_list.fboard?food=한식'">목록</button>
