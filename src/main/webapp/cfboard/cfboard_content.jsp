								...
								<c:choose>
									<c:when test="${sessionScope.member_id == vo.id }">
										...
										<button type="button" class="btn btn-default"
											onclick="location.href='cfboard_list.fboard?food=중식'">목록</button>
										<button type="button" class="btn btn-default"
											onclick="location.href='cfboard_modify.fboard?fno=${vo.fno}&food=중식'">수정</button>
										<button type="button" class="btn btn-default"
											onclick="location.href='cfboard_delete.fboard?fno=${vo.fno}&food=중식'">삭제</button>
									</c:when>
									<c:otherwise>
										<button type="button" class="btn btn-default"
											onclick="location.href='cfboard_list.fboard?food=중식'">목록</button>
