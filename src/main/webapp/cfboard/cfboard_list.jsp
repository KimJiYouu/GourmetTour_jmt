...
<div class="container">
	<div class="box">
		<div class="container">
			<h2 style="font-family: 'Charmonman', cursive;">Chinese jmt</h2>
			<br>
				...
				<tbody>
					<c:forEach var="vo" items="${list }" varStatus="x">
						<tr>
							...
							<td>${vo.region }</td>
							<td style="width: 35%"><a href="cfboard_content.fboard?fno=${vo.fno }" onclick="location.href='cfboard_hitCount.fboard?fno=${vo.fno}'">${vo.title }</a></td>
				...
				<tbody>
					<tr>
						<td colspan="6" align="center">
							<form action="cfboard_search.fboard" class="form-inline">
							<input type="hidden" name="food" value="중식">
								<div class="form-group">
									<input type="text" name="search" placeholder="제목검색"
										...
										<input type="button" value="글 작성" class="btn btn-default" onclick="location.href='cfboard_write.fboard'">
										</c:if>
								</div>
							</form>
						</td>
